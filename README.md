<img src="docs/icon-rounded.png" width="210" align="right" />
...
[`download`](https://github.com/eduardostuart/homewizard/releases/latest) · [`development`](docs/DEVELOPMENT.md) · [`security`](./SECURITY.md) · [`license`](./LICENSE)
